 ...
 * @author IPT
 */
public class SaudeCerteira extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(SaudeCerteira.class.getName());

    /**
     * Creates new form MyService
     */
    public SaudeCerteira() {
        initComponents();
    }
    ...
    private void btAddTransactionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btAddTransactionActionPerformed
        try {
            ...
            System.getLogger(SaudeCerteira.class.getName()).log(System.Logger.Level.ERROR, (String) null, ex);
        } 
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new SaudeCerteira().setVisible(true));
    }
